...
/// Аппбар
///   - Кнопка назад
///   - Тайтл "Детализация user_name"
/// Тело
///   - Фото юзера
///   - Информация(логин, емейл и тд)
///
class DetailsScreen extends StatefulWidget {
  /// Имя пользователя отображаемого в детализации
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("деталка ${widget.userName}"),
      ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Divider(),
                    Text(
                      "long long long long long long long long long long long long long long longlong long long long long long description",
